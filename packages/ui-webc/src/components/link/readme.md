...
| `type`          | `type`            | There are two types. If you intend to use it as a button with onclick, a button is rendered, however if you want to you it as a normal link, a link with href is rendered.                                                                                                                                                     | `"button" \| "link"`                                        | `"button"`  |
